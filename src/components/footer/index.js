        ...
        <div className="footer-innter-container">
                    ...
                    <ul className="nav-link-list">
                        ...
                        <li className="nav-link">
                            <Link to="/blog/">
                                ...
                                <p className="menu-link-text">Read blog posts</p>
                            </Link>
                        </li>
            ...
            <div className="footer-contents-section project-section">
                ...
                <ul className="project-list">
                    ...
                    <li>
                        <a href="https://github.com/miyazakimaiko/Correct-Order">
                    ...
                    <li>
                        <a href="https://chrome.google.com/webstore/detail/vocab-note/obnmagkhjbjbolndeminbibodlfjnabp?hl=en&gl=IE">
                            Vocab Note - Chrome Extension
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" 
                                fill="currentColor" 
                                className="bi bi-box-arrow-up-right icon" 
                                viewBox="0 0 16 16"
                            >
                                <path 
                                    fill-rule="evenodd" 
                                    d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 
                                    1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z"
                                />
                                <path 
                                    fill-rule="evenodd" 
