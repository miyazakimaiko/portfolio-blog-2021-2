...
export const query = graphql`query ReadNextQuery($relatedFileAbsolutePaths: [String]) {
  allMarkdownRemark(filter: {fileAbsolutePath: {in: $relatedFileAbsolutePaths}}, limit: 4) {
    edges {
      node {
        id
        frontmatter {
